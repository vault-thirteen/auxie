...
const (
	...
	TypeTextDirectoryDEPRECATEDByRFC6350  = "text/directory"                        // [RFC2425][RFC6350]
	TypeTextDns                           = "text/dns"                              // [RFC4027]
	TypeTextEcmascript                    = "text/ecmascript"                       // [RFC9239]
	...
	TypeTextVndSiUricatalogue             = "text/vnd.si.uricatalogue"              // [Nicholas_Parks_Young]
